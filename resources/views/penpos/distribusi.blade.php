...
@section('content')
    <div class="card m-auto mt-5 shadow-sm" style="height:30em;width:40em;">
            ...
            <div class="team-select-section">
                <form class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="team" id="team" class="select2 w-25 mb-3" onchange="loadGanti()" required>
                    ...
                    <div class="col-md-6">
                         {{-- Pilih Jalur --}}
                            ...
                            <select name="jalur" id="jalur" class="select2 w-25 mb-3" onchange="loadGanti()" required>
                    ...
                    <div class="col-md-4">
                         {{-- Pilih Jenis Transportasi --}}
                            ...
                            <select name="jenisTransport" id="jenisTransport" class="select2 w-25 mb-3" onchange="loadGanti()" required>
